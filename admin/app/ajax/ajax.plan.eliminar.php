...
$consulta_select_plan = "SELECT * FROM planes WHERE `id_planes`='$codigo_plan'";
$resultado = mysqli_query($conexion, $consulta_select_plan);
...
">
    <div class="card border-danger mb-3 mx-auto" style="max-width: 1000px">
      ...
      <div class="card-body text-danger">
        <div class="row">
        <div class="col-md-6">
                    <label for="inputAddress" class="form-label">Id Plan</label>
                    <input value="<?=$datos_plan['id_planes']?>" type="number" class="form-control" id="inputAddress" placeholder="Id Plan" name="id-plan" />
      ...
      <div class="card-footer bg-transparent border-danger">
        <div class="col-12">
          <input type="hidden" name="eliminar-plan" value="true" />
