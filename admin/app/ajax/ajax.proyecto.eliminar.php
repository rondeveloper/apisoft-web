    ...
    <div class="card border-danger mb-3 mx-auto" style="max-width: 1000px">
      ...
      <div class="card-body text-danger">
        ...
        <div class="col-md-6">
                    ...
                    <input value="<?=$datos_proyecto['id_proyecto']?>" type="number" class="form-control" id="inputAddress" placeholder="Id Proyecto" name="id-proyecto" />
                  </div>
        <div class="col-md-6">
      ...
      <div class="card-footer bg-transparent border-danger">
        <div class="col-12">
          <input type="hidden" name="eliminar-proyecto" value="true" />
