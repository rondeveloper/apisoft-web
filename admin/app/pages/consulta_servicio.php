...
if (isset($_POST['editar-consulta_servicio'])) {
  ...
  $consulta_update_consulta_servicio = "UPDATE consulta_servicio SET  
    `id_servicio`='$id_servicio', `id_cliente`='$id_cliente',
     ...
     `id_encargado`='$id_encargado', `observacion_costo_servicio`='$observacion_costo_servicio',`estado`='$estado'
...
<div class="d-flex justify-content-between">
  <h4 class="text-primary fw-bolder fs-2 my-0">Consulta Servicio <i class='bx bx-user-voice bx-flashing fs-3' ></i></h4>
