...
<div class="d-flex justify-content-between">
    <h4 class="text-primary fw-bolder fs-2 my-0">Cotizaciones <i class='bx bxs-quote-single-right bx-flashing fs-3' ></i></h4>
...
?>
<hr>
<table id="mytable" class="table table-striped table-light table-hover table-bordered" style="font-size:13px">
  <thead>
    <tr>
      <th scope="col">#</th>
